...
#This code is the GUI based off the classes above
#I will add more windows later on 
# I will also integrate to SQL to store the data 
#As of right now I have it to where it is just one window that allows you to 
